...
try {
    $stmt = $pdo->query("SELECT * FROM reservations"); // Adjust the query based on your database schema
...
<head>
    ...
    <style>
        body {
            ...
            align-items: center;
            height: 100vh;
            flex-direction: column; /* Added for column layout */
        }
        ...
        .container {
            ...
            max-width: 600px;
            width: 100%;
            margin-top: 20px; /* Added for spacing below the image */
        }
                    ...
                    <tr>
                        ...
                        <td>
                            <?php if ($reservation['date'] <= $currentDate) : ?>
                                <a href="comment.php?reservation_id=<?php echo $reservation['table_id']; ?>">Leave a Comment</a>
                            <?php endif; ?>
                        </td>
                    </tr>
                <?php endforeach; ?>
